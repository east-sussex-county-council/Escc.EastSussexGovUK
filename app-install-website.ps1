...
robocopy $sourceFolder "$destinationFolder\$projectName" /S /PURGE /IF *.dll *.ico *.css *.js apple-*.png navigation.png desktop.png pan-*.gif item-type.png default.aspx logo-large.gif google*.html csc.* csi.* /XD aspnet_client obj Properties "Web References"
