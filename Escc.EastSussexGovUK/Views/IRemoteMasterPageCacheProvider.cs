...
namespace Escc.EastSussexGovUK.Views
{
    ...
    public interface IRemoteMasterPageCacheProvider
    {
        ...
        bool CachedVersionExists(string applicationId, string controlId, string selectedSection, int textSize, bool isLibraryCatalogueRequest);
        ...
        /// </value>
        bool CachedVersionIsFresh(string applicationId, string controlId, string selectedSection, int textSize, bool isLibraryCatalogueRequest);
        ...
        /// <param name="isLibraryCatalogueRequest"><c>true</c> if the request is from a public catalogue machine in a library</param>
        /// <returns></returns>
        string ReadHtmlFromCache(string applicationId, string controlId, string selectedSection, int textSize, bool isLibraryCatalogueRequest);
        ...
        void SaveRemoteHtmlToCache(string applicationId, string controlId, string selectedSection, int textSize, bool isLibraryCatalogueRequest, string html);
    }
}