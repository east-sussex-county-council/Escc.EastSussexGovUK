...
<div class="header" role="banner">
    <div class="context container">
        ...
        <nav>
            <ul>
                <li><a href="/" id="mobileHome" runat="server" accesskey="1" enableviewstate="false">Home</a></li>
                <li><a href="/menu/" id="mobileMenu" runat="server" accesskey="3" enableviewstate="false">Menu</a></li>
            </ul>
        </nav>
        </div>
    </div>
