<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Error404.ascx.cs" Inherits="EsccWebTeam.EastSussexGovUK.MasterPages.Controls.Error404" %>
<div class="text">
    ...
    <ul>
        ...
        <li>try using the <a href="/atoz/default.aspx">A-Z of services</a> </li>
