if (typeof (jQuery) !== 'undefined' && typeof (jQuery.bt) !== 'undefined') {
    $(function () {
        ...
        // <p id="example">We'll use this data for xxx. We won't use it for anything else or share it. You can ask us to delete it.</p>
        ...
        $("[aria-describedby].describedby-tip").each(function () {
            ...
            input.bt(tip.html() + ' [<a href="#" data-closes-tip="' + input.attr("id") + '">close</a>]', {
                trigger: ['focus', 'blur'],
                fill: '#ffc',
                strokeStyle: '#c0c060',
